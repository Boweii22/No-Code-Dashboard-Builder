...
function getIndexByName(names, state, lower) {
  var i3 = 0, length = names.length, name, nameLength, matchLength = 0, matchIdx = 0, subValue;
  for (; i3 < length; i3++) {
    name = names[i3];
...
// node_modules/@progress/kendo-react-intl/package-metadata.mjs
var e = {
...
var c = class {
   ...
   */
  format(r3, ...t7) {
    return t7.length === 1 && Array.isArray(t7[0]) ? format(r3, t7[0], this.locale) : format(r3, t7, this.locale);
  }
  /**
   ...
   */
  formatDate(r3, t7) {
    return formatDate(r3, t7, this.locale);
  }
  /**
   ...
   */
  toString(r3, t7) {
    return toString(r3, t7, this.locale);
  }
  /**
   ...
   */
  parseNumber(r3, t7) {
    return parseNumber(r3, this.locale, t7);
  }
  /**
   ...
   */
  parseDate(r3, t7) {
    return parseDate(r3, t7, this.locale);
  }
  /**
   ...
   */
  formatNumber(r3, t7) {
    return formatNumber(r3, t7, this.locale);
  }
  /**
   ...
   */
  dateFieldName(r3) {
    return dateFieldName(r3, this.locale);
  }
  /**
   ...
   */
  dateFormatNames(r3) {
    return dateFormatNames(this.locale, r3);
  }
  /**
   ...
   */
  splitDateFormat(r3) {
    return splitDateFormat(r3, this.locale);
  }
  /**
...
var r = class {
  ...
  toLanguageString(e6, a3) {
    return this.language && e2[this.language] && e2[this.language].hasOwnProperty(e6) ? e2[this.language][e6] : a3;
  }
};

// node_modules/@progress/kendo-react-intl/globalization/GlobalizationContext.mjs
var t = __toESM(require_react(), 1);
var r2 = t.createContext({
  intl: new c("en"),
  localization: new r()
});
...
function a(t7) {
  if (!t7 && true)
    throw `Passed component - ${t7} is invalid.`;
  const i3 = t7.context;
  return i3 && i3.intl ? i3.intl : new c("en");
}
function s(t7) {
  if (!t7 && true)
    throw `Passed component - ${t7} is invalid.`;
  const i3 = t7.context;
  return i3 && i3.localization ? i3.localization : new r();
}
function p(t7) {
  t7.contextType = r2;
}
...
var t3 = class t4 extends e4.Component {
   ...
   */
  render() {
    return e4.createElement(r2.Consumer, null, (n2) => e4.createElement(r2.Provider, { value: { ...n2, intl: this.getIntlService() } }, this.props.children));
  }
};
t3.propTypes = {
...
var t5 = class t6 extends e5.Component {
  /**
   ...
   */
  render() {
    return e5.createElement(r2.Consumer, null, (i3) => e5.createElement(r2.Provider, { value: { ...i3, localization: this.getLocalizationService() } }, this.props.children));
  }
};
t5.propTypes = {
...
@progress/kendo-react-intl/package-metadata.mjs:
  (**
   * @license
   *-------------------------------------------------------------------------------------------
...
@progress/kendo-react-intl/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-JRA7E26J.js.map
