...
import { provideLocalizationService as c, registerForLocalization as v } from "@progress/kendo-react-intl";
import { statusUploadFailed as l, messages as r, statusUploaded as m } from "./messages/index.mjs";
...
class M extends a.Component {
  ...
  renderValidationError(e, i) {
    return /* @__PURE__ */ a.createElement("span", { className: "k-file-info", key: "2" }, /* @__PURE__ */ a.createElement("span", { className: "k-file-name", title: e.name }, e.name), /* @__PURE__ */ a.createElement("span", { className: "k-file-validation-message" }, this.getFileValidationMessage(e, i)));
  }
  /**
   * @hidden
   */
  renderFileDetails(e) {
    const s = c(this).toLanguageString(m, r[m]);
    return /* @__PURE__ */ a.createElement("span", { className: "k-file-info", key: "2" }, /* @__PURE__ */ a.createElement("span", { className: "k-file-name", title: e.name }, e.name), e.progress !== 100 ? /* @__PURE__ */ a.createElement("span", { className: "k-file-size" }, p.getTotalFilesSizeMessage([e])) : /* @__PURE__ */ a.createElement("span", { className: "k-file-validation-message" }, s));
  }
  /**
   * @hidden
   */
  render() {
    ...
    return /* @__PURE__ */ a.createElement(
      ...
      f && /* @__PURE__ */ a.createElement(u, { value: s.progress || 0 }),
      /* @__PURE__ */ a.createElement("span", { className: "k-file-icon-wrapper", key: "1" }, /* @__PURE__ */ a.createElement(d, { className: "k-file-icon", ...this.getFileExtensionIcon(s), size: "xxlarge" }), /* @__PURE__ */ a.createElement("span", { className: "k-file-state" })),
      o || t ? this.renderValidationError(s, t) : this.renderFileDetails(s),
