    ...
    super(v), this._httpSubscriptions = {}, this._uploadNavigation = null, this.focus = () => {
      ...
      p.setFilesStatus(i, r.Uploading), p.groupForEach(i, (s, a) => {
        ...
        if (this.isCustomSave)
          this.props.saveUrl(s, { formData: u, requestOptions: c }, this.onUploadProgress).then((d) => this.onUploadSuccess(d.uid)).catch((d) => this.onUploadError(d.uid));
        else {
      ...
      let t = F.getAllFileInfo(i), s;
      if (t = F.assignGuidToFiles(t, this.async.batch), E.validateFiles(t, this.props.restrictions), this.props.multiple ? s = this.fileStateCopy : s = [], p.addMany(t, s), this.async.autoUpload) {
  ...
  render() {
    ...
    return /* @__PURE__ */ S.createElement(
      b,
      {
        ...
        showActionButtons: n && !a && !!Object.keys(h).length,
        actionsLayout: o,
        autoUpload: a,
        disabled: c,
        onAdd: this.onAdd,
        ...
        tabIndex: y(l, c),
        ref: (U) => this._uploadNavigation = U,
        ...u
      }
    );
  }
...
m.defaultProps = {
  ...
  defaultFiles: e.arrayOf(e.shape({
    uid: e.string,
    name: e.string,
    extension: e.string,
    size: e.number,
